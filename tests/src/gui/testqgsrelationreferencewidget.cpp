...
void TestQgsRelationReferenceWidget::init()
{
  ...
  mLayer2 = new QgsVectorLayer( QStringLiteral( "LineString?field=pk:int&field=material:string&field=diameter:int&field=raccord:string&field=multipicator:int" ), QStringLiteral( "vl2" ), QStringLiteral( "memory" ) );
  ...
  ft2.setAttribute( QStringLiteral( "multiplicator" ), 1 );
  mLayer2->startEditing();
  ...
  ft2.setAttribute( QStringLiteral( "multiplicator" ), 5 );
  mLayer2->startEditing();
...
void TestQgsRelationReferenceWidget::testSorting()
{
  ...
  // ... and order descent
  w.setRelation( *mRelation, false, QString(), true );
  spy.wait();
  QCOMPARE( w.mComboBox->count(), 3 );
  ...
  w.setRelation( *mRelation, false, "'test '||(diameter * multiplicator)", false );
  spy.wait();
  QCOMPARE( w.mComboBox->count(), 3 );
  QCOMPARE( w.mComboBox->itemData( 0, Qt::DisplayRole ).toString(), "l2 sleeve" );
  QCOMPARE( w.mComboBox->itemData( 1, Qt::DisplayRole ).toString(), "l2 brides" );
  QCOMPARE( w.mComboBox->itemData( 2, Qt::DisplayRole ).toString(), "l2 collar" );

  // ... and order descent
  w.setRelation( *mRelation, false, "'test '||(diameter * multiplicator)", true );
  spy.wait();
  QCOMPARE( w.mComboBox->count(), 3 );
  QCOMPARE( w.mComboBox->itemData( 0, Qt::DisplayRole ).toString(), "l2 collar" );
  QCOMPARE( w.mComboBox->itemData( 1, Qt::DisplayRole ).toString(), "l2 brides" );
  QCOMPARE( w.mComboBox->itemData( 2, Qt::DisplayRole ).toString(), "l2 sleeve" );


  //sorting setting - orders according orderby expression what is set to "multiplicator"
  //results in "1" (l2 sleeve), "5" (l2 collar), "10" (l2 brides)
  //where this order should be made numerical and have 5 before 10
  w.setRelation( *mRelation, false, "multiplicator", false );
  spy.wait();
  QCOMPARE( w.mComboBox->count(), 3 );
  QCOMPARE( w.mComboBox->itemData( 0, Qt::DisplayRole ).toString(), "l2 sleeve" );
  QCOMPARE( w.mComboBox->itemData( 1, Qt::DisplayRole ).toString(), "l2 collar" );
  ...
  // ... and order descent
  w.setRelation( *mRelation, false, "multiplicator", true );
  spy.wait();
  QCOMPARE( w.mComboBox->count(), 3 );
  QCOMPARE( w.mComboBox->itemData( 0, Qt::DisplayRole ).toString(), "l2 brides" );
  QCOMPARE( w.mComboBox->itemData( 1, Qt::DisplayRole ).toString(), "l2 collar" );
